...
<header style={{ 
  ...
  background: 'rgba(10, 31, 10, 0.95)', // solid base
...
<div style={{
  ...
  left: 0,
  right: 0,
  height: '5rem',       // matches header height + buffer
  zIndex: 15,           // just below header
  pointerEvents: 'none',
...
<div style={{ 
  ...
  overflow: 'auto',
  paddingTop: '6rem', // leaves space for header + fade
}}>

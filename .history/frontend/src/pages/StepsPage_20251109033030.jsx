...
// Animated Network Background for Mind Map
    ...
    function animate() {
      ...
      particles.forEach(particle => {
        ...
        particles.forEach(other => {
          ...
          if (distance < 120) {
            ctx.strokeStyle = `rgba(134, 239, 172, ${0.15 * (1 - distance / 120)})`;
            ctx.lineWidth = 1;
            ctx.beginPath();
    ...
    <div style={{ 
      ...
      {!expandedStep ? (
        ...
        <div style={{
          ...
          {/* Mind Map - Animated Network Design */}
          <div style={{ 
            position: 'relative', 
            width: '700px', 
            height: '700px',
                ...
                <React.Fragment key={step.number}>
                  ...
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: '0 6px 25px rgba(134, 239, 172, 0.4)'
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.transform = 'translate(-50%, -50%) scale(1.2)';
                      e.currentTarget.style.boxShadow = '0 10px 40px rgba(134, 239, 172, 0.7)';
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = 'translate(-50%, -50%) scale(1)';
                      e.currentTarget.style.boxShadow = '0 6px 25px rgba(134, 239, 172, 0.4)';
                    }}
                  >
                    {step.number}
                  </div>

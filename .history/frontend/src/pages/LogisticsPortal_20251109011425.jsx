      ...
      <section style={{ padding: '5rem 3rem', background: '#0a1f0a' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ 
            ...
            <div
              onClick={() => setPage('about', null, 'blockchain-security')}  // ADD THIS LINE
            ...
            <div
              onClick={() => setPage('about', null, 'real-time-tracking')}  // ADD THIS LINE
            ...
            <div
              onClick={() => setPage('about', null, 'consumer-trust')}  // ADD THIS LINE

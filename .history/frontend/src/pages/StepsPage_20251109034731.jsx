...
// Random positions for mind-map layout
const nodePositions = [
  { x: -180, y: -220 },  // Top left
  { x: 150, y: -240 },   // Top right
  { x: -280, y: -50 },   // Middle left
  { x: 280, y: -80 },    // Middle right
  { x: -200, y: 150 },   // Bottom left
  { x: 100, y: 180 },    // Bottom middle
  { x: 250, y: 50 }      // Right middle
];
    ...
    <div style={{ 
      ...
      {!expandedStep ? (
        ...
        <div style={{
          ...
          {/* Mind Map - Random Organic Layout */}
          <div style={{ 
            position: 'relative', 
            width: '700px', 
            height: '600px',
            ...
            <div style={{
              ...
              padding: '1.5rem',
              zIndex: 10,
              boxShadow: '0 0 40px rgba(134, 239, 172, 0.6)',
            ...
            {stepsData.map((step, index) => {
              ...
              return (
                <React.Fragment key={step.number}>
                  {/* Connection Line - Organic curves */}
                  <svg style={{
                    position: 'absolute',
                    top: 0,
                    left: 0,
                    ...
                    <path
                      d={`M 350 300 Q ${350 + pos.x * 0.3} ${300 + pos.y * 0.3} ${350 + pos.x} ${300 + pos.y}`}
                  ...
                  {/* Step Label - positioned dynamically */}
                  <div style={{
                    position: 'absolute',
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              {/* Full Description - Fancy Serif Font */}
              <p style={{
                fontSize: '1.375rem',
                color: '#d1fae5',
                lineHeight: '1.9',

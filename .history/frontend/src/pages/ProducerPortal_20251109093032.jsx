        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            {mode === "transfer" && (
              <>
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', color: '#d1fae5', fontSize: '0.875rem' }}>Crate Numbers (Optional)</label>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              <div>
                <label style={{ display: 'block', marginBottom: '0.5rem', color: '#d1fae5', fontSize: '0.875rem' }}>Latitude (Auto)</label>
                <input type="text" name="latitude" value={formData.latitude} readOnly style={{ ...inputStyle, background: 'rgba(134, 239, 172, 0.1)', cursor: 'not-allowed' }} />
              </div>
              <div>
                <label style={{ display: 'block', marginBottom: '0.5rem', color: '#d1fae5', fontSize: '0.875rem' }}>Longitude (Auto)</label>
                <input type="text" name="longitude" value={formData.longitude} readOnly style={{ ...inputStyle, background: 'rgba(134, 239, 172, 0.1)', cursor: 'not-allowed' }} />
              </div>
            </div>
